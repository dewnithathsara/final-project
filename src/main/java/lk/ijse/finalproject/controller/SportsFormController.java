...
public class SportsFormController {
    public AnchorPane sportsPane;
    ...
    public void btnSaveOnAction(ActionEvent actionEvent) {
        try {
            ...
            if (isAdded) {
                ...
                new Alert(Alert.AlertType.CONFIRMATION, "sports event isn't added").show();
            }
        } catch (Exception e) {
    ...
    public void btnUpdateOnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            if (isUpdated) {
                ...
                new Alert(Alert.AlertType.CONFIRMATION, "sports event isn't updated").show();
            }
        } catch (Exception e) {
            new Alert(Alert.AlertType.ERROR, e.getMessage()).show();
        }
    ...
    public void btnDeleteOnAction(ActionEvent actionEvent) {
        ...
        try{
            ...
            if(isDeleted){
                ...
                new Alert(Alert.AlertType.CONFIRMATION," sports event is not deleted");
            }
        }catch(Exception e){
            new Alert(Alert.AlertType.ERROR,e.getMessage()).show();
        }
    ...
    public void btnBackOnAction(ActionEvent actionEvent) throws IOException {
        Navigation.navigate(Route.EVENT_DESIGN,sportsPane);
    }
