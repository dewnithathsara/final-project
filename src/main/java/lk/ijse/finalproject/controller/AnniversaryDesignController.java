...
public class AnniversaryDesignController {
   // public AnchorPane anniversaryPane;
    ...
    public void btnUpdateOnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            if (isUpdated) {
                ...
                new Alert(Alert.AlertType.CONFIRMATION, "anniversary isn't updated").show();
            }
        } catch (Exception e) {
            new Alert(Alert.AlertType.ERROR, e.getMessage()).show();
        }
    ...
    public void btnClearOnActoin(ActionEvent actionEvent) {
        clearFields();
    }
    ...
    public void btnBackOnAction(ActionEvent actionEvent) throws IOException {
        Navigation.navigate(Route.EVENT_DESIGN,AnniveersaryPane);
    }
    ...
    private boolean validateFields() {
        ...
        /*if (!validate(lblEvent.getText(), eventRegex)) {
            new Alert(Alert.AlertType.ERROR, "Invalid clientId format. Please enter a valid description.").show();
            return false;
        }*/
        return true;
