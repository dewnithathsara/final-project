...
public class ConcertFormController {
    public AnchorPane concertPane;
    ...
    public void btnSaveOnAction(ActionEvent actionEvent) {
        if(validateFields()) {
            try {
                ...
                if (isAdded) {
                    new Alert(Alert.AlertType.CONFIRMATION, "concert event is added").showAndWait();

                } else {
                    new Alert(Alert.AlertType.CONFIRMATION, "concert isn't added").show();
                }
            } catch (Exception e) {
    ...
    public void btnUpdateOnAction(ActionEvent actionEvent) {
        ...
        var dto = new EventDesignDto(id, type, location, aId, time, date, theme,status);        try {
            ...
            if (isUpdated) {
                new Alert(Alert.AlertType.CONFIRMATION, "concert event is updated").showAndWait();

            } else {


                new Alert(Alert.AlertType.CONFIRMATION, "concert isn't updated").show();
            }
        } catch (Exception e) {
            new Alert(Alert.AlertType.ERROR, e.getMessage()).show();
        }
    ...
    public void btnDeleteOnAction(ActionEvent actionEvent) {
        ...
        try{
            ...
            if(isDeleted){
                new Alert(Alert.AlertType.CONFIRMATION,"concert is deleted").show();
            }else{
                new Alert(Alert.AlertType.CONFIRMATION," concert is not deleted");
            }
        }catch(Exception e){
            new Alert(Alert.AlertType.ERROR,e.getMessage()).show();
        }
    ...
    public void btnBackOnAction(ActionEvent actionEvent) throws IOException {
        Navigation.navigate(Route.EVENT_DESIGN,concertPane);
    }
